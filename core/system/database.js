...
export const defSets = {
  ...
  prefix: '[\"/\",\"!\",\".\",\"#\"]',
  commandsejecut: 0,
  newsletter_id: '120363409871770595@newsletter',
  nameid: '𝓚𝓪𝓸𝓻𝓾𝓴𝓸',
  type: 'Owner',
  link: '',
  banner: 'https://files.catbox.moe/vhffmi.jpg',
  icon: 'https://files.catbox.moe/nm1qnn.jpg',
  currency: 'Coins',
  namebot: '𝓚𝓪𝓸𝓻𝓾𝓴𝓸',
  botname: '𝓚𝓪𝓸𝓻𝓾𝓴𝓸',
  owner: ''
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      newsletter_id TEXT DEFAULT '120363409871770595@newsletter',
      nameid TEXT DEFAULT '𝓚𝓪𝓸𝓻𝓾𝓴𝓸',
      type TEXT DEFAULT 'Owner',
      link TEXT DEFAULT '',
      banner TEXT DEFAULT 'https://files.catbox.moe/vhffmi.jpg',
      icon TEXT DEFAULT 'https://files.catbox.moe/nm1qnn.jpg',
      currency TEXT DEFAULT 'Coins',
      namebot TEXT DEFAULT '𝓚𝓪𝓸𝓻𝓾𝓴𝓸',
      botname TEXT DEFAULT '𝓚𝓪𝓸𝓻𝓾𝓴𝓸',
      owner TEXT DEFAULT ''
    )`);
